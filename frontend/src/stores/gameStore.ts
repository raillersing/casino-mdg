...
export const useGameStore = create<GameState>((set) => ({
  isAuthenticated: typeof window !== 'undefined' && Boolean(localStorage.getItem('mdg_access_token')),
  user: null,
  currentTable: null,
  currentGame: null,
  isReconnecting: false,
  language: 'fr',
  accessToken: typeof window !== 'undefined' ? localStorage.getItem('mdg_access_token') : null,
  refreshToken: typeof window !== 'undefined' ? localStorage.getItem('mdg_refresh_token') : null,
