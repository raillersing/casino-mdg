...
export function requestOtp(phone: string) {
  return post<OtpRequestResponse>("otp/request/", { phone });
}
export function verifyOtp(phone: string, code: string, displayName: string) {
  return post<AuthResponse>("otp/verify/", {
    phone,
    code,
